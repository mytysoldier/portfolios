...
import com.example.koog_inv_app.repository.ChatComplexWorkflowRepository
...
//    private val repository: ChatFunctionalRepository = ChatFunctionalRepository()
            private val repository: ChatComplexWorkflowRepository = ChatComplexWorkflowRepository()
) : ViewModel() {
